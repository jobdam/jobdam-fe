...
const LandingCard = () => {
  return (
    <div className="grid grid-cols-3 h-[600px]  min-w-[1440px] ">
      <div
        className="relative pt-[40px] pl-[40px] w-[453px]
       h-[319px] rounded-[10px] bg-[#282828]"
      >
        <span className="text-white text-[24px] font-bold leading-[150%]">
          잡담 AI로 내 면접 예상질문<br></br>
          쉽고 빠르게 뽑아요
        </span>
        <div className="absolute left-[40%] top-[42%] aspect-square  size-[289px]">
          <img className="" src={folder}></img>
        </div>
      </div>
      <div
        className="relative pt-[40px] pl-[40px] gap-x-[40px]   w-[453px]
       h-[319px] rounded-[10px] bg-[#282828]"
      >
        <span className="text-white text-[24px] font-bold leading-[150%]">
          같은 면접자들끼리 <br></br>
