...
import PrivacyPolicy from "@/constants/privacyContents";
        ...
        return (
          <>
            <div
              ...
              className="flex flex-col mb-[10px] space-y-[26px]  text-left"
            >
              ...
              <Input
                ...
                placeholder:text-[18px]
                placeholder:font-normal 
                text-left h-[70px] border border-[rgba(0,0,0,0.3)] text-black"
              ...
              />
              <div className="flex  mt-[40px] gap-[16px] flex-col">
                <div className="flex flex-col">
                  <div className="flex flex-row">
                    ...
                    ></Checkbox>
                    <Label className="text-[16px] pl-[3px] pt-[8px] text-[black] font-semibold">
                      전체동의
                    </Label>
                  </div>
                ...
                <div className="flex flex-row items-center">
                  <Checkbox
                    ...
                    className=" rounded-[5px] border-[1px] bg-[rgba(0,0,0,0.05)] border-[rgba(0,0,0,0.30)]"
                  ></Checkbox>
                  <Label className="text-[14px] pl-[3px] pt-[5px] text-[black] font-medium">
                    [필수] 만 14세 이상입니다.
                  </Label>
                </div>
                <div className="flex flex-row items-center">
                  ...
                  <div className="ml-auto cursor-pointer">
                    <AlertDialog
                      ...
                      contents={<TermsContents></TermsContents>}
                      title="서비스 이용약관"
                      children={<div className="text-right">보기</div>}
                    ></AlertDialog>
                  </div>
                </div>
                ...
                <div className="flex flex-row items-center">
                  ...
                  <Label className="pl-[3px] text-[14px] pt-[5px]  text-[black] font-medium">
                    [필수]{" "}
                  ...
                  <div className="ml-auto cursor-pointer">
                    <AlertDialog
                      open={open}
                      onOpenChange={setOpen}
                      contents={<PrivacyPolicy></PrivacyPolicy>}
              ...
              <div className=" pointer-cursor flex justify-center items-center mt-[178px] mb-[78px]">
                <Button isLoading={registering.isPending}>회원가입 완료</Button>
              </div>
            </div>
          </>
        );
